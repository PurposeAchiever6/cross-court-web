  ...
  return (
    ...
    >
      <g filter="url(#filter0_d)">
        <circle cx="41.5" cy="39.5" r="27.5" fill={selected ? colors.white : colors.polarPlum} />
        <circle cx="41.5" cy="39.5" r="25" fill={selected ? colors.polarPlum : colors.white} />
        <mask
          id="mask0"
          mask-type="alpha"
        ...
        <g mask="url(#mask0)">
          <path
            ...
            fill={selected ? colors.white : colors.polarPlum}
          />
        </g>
      </g>
      <defs>
