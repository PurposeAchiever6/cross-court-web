    ...
    <MarkerContainer>
      ...
      >
        <g filter="url(#filter0_d)">
          <circle cx="41.5" cy="39.5" r="27.5" fill={selected ? colors.white : '#9999FF'} />
          <circle cx="41.5" cy="39.5" r="25" fill={selected ? '#9999FF' : colors.white} />
          <mask
            id="mask0"
            mask-type="alpha"
          ...
          <g mask="url(#mask0)">
            <path
              ...
              fill={selected ? colors.white : '#9999FF'}
            />
          </g>
        </g>
        <defs>
