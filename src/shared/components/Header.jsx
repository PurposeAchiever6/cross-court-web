...
const BLACK_BG = [ROUTES.HOME, ROUTES.MEMBERSHIPS, ROUTES.FIRSTSESSIONRESERVED, ROUTES.FAQ];

const SHOW_NAVBAR = [ROUTES.HOME, ROUTES.MEMBERSHIPS, ROUTES.FIRSTSESSIONRESERVED, ROUTES.FAQ];
