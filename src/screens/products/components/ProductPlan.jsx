    ...
    >
      ...
      <div className="mb-6 lg:mb-10">
        ...
        {isRecurring && showFeatures && (
          <div className="h-52 lg:h-72 flex flex-col">
      ...
      <div className="absolute lg:static right-5 top-36 transform lg:transform-none -translate-y-1/3 lg:mb-4">
        <PrimaryButton
      ...
      <div className="lg:h-4">{isDropIn && <div className="text-xs">*Expires in 30 Days</div>}</div>
      {label && (
        <>
