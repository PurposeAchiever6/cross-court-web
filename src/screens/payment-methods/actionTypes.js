...
export const UPDATE_CARD_INIT = '@payment-methods/UPDATE_CARD_INIT';
export const UPDATE_CARD_SUCCESS = '@payment-methods/UPDATE_CARD_SUCCESS';
export const UPDATE_CARD_FAILURE = '@payment-methods/UPDATE_CARD_FAILURE';
