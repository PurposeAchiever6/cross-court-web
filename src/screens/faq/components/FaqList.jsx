...
const QUESTIONS = [
  ...
  },
  {
    ...
    answer:
      'When our founders met in college, they bonded over their love for sport - specifically team sport. Why? Because team sport provides opportunities for self-improvement, self-discovery, and authentic connection.\n\nAfter entering the workforce, they realized that the opportunities provided by team sport were not as easy to find in their professional careers. But they believed the connection between the sports that inspired them and the lives they envisioned was too strong to ignore. So they created Crosscourt - a basketball inspired social club designed to help professionals in the game of life unlock their potential.',
  },
  {
