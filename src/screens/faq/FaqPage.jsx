  ...
  return (
    <PageLayout dark={false}>
      <SectionLayout className="max-w-5xl mx-auto">
        ...
        <Accordion title="What is Crosscourt?" dark={false} className="mb-2">
        ...
        <Accordion title="What is the format of a session?" dark={false} className="mb-2">
          <ul>
            <li>
        ...
        <Accordion title="What if I'm not good at basketball?" dark={false} className="mb-2">
        ...
        <Accordion title="How many calories are burned per session?" dark={false} className="mb-2">
        ...
        <Accordion title="What do I need to wear and bring?" dark={false} className="mb-2">
        ...
        <Accordion title="What's the cancellation policy?" dark={false} className="mb-2">
        ...
        <Accordion
          ...
          className="mb-2"
        >
          In order to cancel a reservation and return your purchased session to your account, you
          must cancel your reservation at least 5 hours prior to the start time of such reservation.
          Once your reservation is cancelled on time, your session credit will be returned to your
          account to be used at a future date. If you haven’t cancelled by the deadline listed
          above, your session credit will be used for the reservation and will no longer be shown in
          your account. Any individual who cancels inside the 5 hour cancellation window will be
          automatically charged a ${env.REACT_APP_CANCELED_OUT_OF_TIME_PRICE} penalty in addition to
          losing a session credit. In case you're cancelling your first free session out of time,
          your session credit will be returned to your account for later use, but you will be
          charged a ${env.REACT_APP_FREE_SESSION_CANCELED_OUT_OF_TIME_PRICE} fee. Booking a
          reservation and "no showing" without cancelling a session you are signed up for, will
          result in a lost of the session credit and a ${env.REACT_APP_NO_SHOW_UP_FEE} no show
          penalty.
        </Accordion>
        <Accordion title="How early should I arrive?" dark={false} className="mb-2">
          We suggest arriving at least 10 minutes early since the first 10 players checked into our
          system will begin the session.
        </Accordion>
        <Accordion title="What happens when I arrive?" dark={false} className="mb-2">
        ...
        <Accordion title="Can I request to be on a specific team?" dark={false} className="mb-2">
        ...
        <Accordion title="How do I book a Session?" dark={false} className="mb-2">
        ...
        <Accordion title="How does the waitlist work?" dark={false} className="mb-2">
        ...
        <Accordion
          ...
          className="mb-2"
        >
          Changes to a membership such as upgrading or downgrading can result in prorated charges.
          For example, if a member upgrades from a 10 USD per month membership to a 20 USD option,
          they&apos;re charged prorated amounts for the time spent on each option. Assuming the
          change occurred halfway through the billing period, the member is billed an additional 5
          USD: -5 USD for unused time on the initial price, and 10 USD for the remaining time on the
          new price.
        </Accordion>
        <Accordion title="How did Crosscourt start?" dark={false} className="mb-2">
          Crosscourt was started by two friends who were passionate about solving a problem they
          dealt with all too often: finding an efficient way to play pickup basketball. Both
          founders grew up around athletics and, after meeting at USC, bonded over their shared
          appreciation for sport, fitness, and culture. Following graduation from school and
          struggling to find a way to easily play pick up basketball, considering their busy work
          schedules, the founders decided to explore an original concept that would not only break
          the mold around pick-up basketball, but also redefine group fitness. Something that would
          allow the modern athlete to continue engaging in the sports they loved in an indoor gym
          setting, while improving their physical and mental wellbeing. Today, Crosscourt’s a
          diverse destination where modern athletes come to sweat and shed stress as equals.
        </Accordion>
        <Accordion title="Want to see our terms & conditions?" dark={false}>
          Link{' '}
