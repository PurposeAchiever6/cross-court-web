  ...
  return (
    <PageLayout dark={false}>
      <SectionLayout className="max-w-5xl mx-auto">
        ...
        <QuestionAnswer question="What is Crosscourt?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="What is the format of a session?" dark={false} className="mb-2">
          <ul>
            <li>
        ...
        <QuestionAnswer
          question="How many calories are burned per session?"
          dark={false}
          className="mb-2"
        >
        ...
        <QuestionAnswer question="What do I need to wear and bring?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="What's the cancellation policy?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="How early should I arrive?" dark={false} className="mb-2">
          We suggest arriving at least 10 minutes early since the first 10 players checked into our
          system will begin the session.
        </QuestionAnswer>
        <QuestionAnswer question="What happens when I arrive?" dark={false} className="mb-2">
        ...
        <QuestionAnswer
          question="Can I request to be on a specific team?"
          dark={false}
          className="mb-2"
        >
        ...
        <QuestionAnswer question="How do I book a Session?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="How does the waitlist work?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="How did Crosscourt start?" dark={false} className="mb-2">
        ...
        <QuestionAnswer question="Want to see our terms & conditions?" dark={false}>
          Link{' '}
