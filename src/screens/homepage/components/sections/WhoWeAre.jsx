...
const WhoWeAre = () => (
  <Section>
    <LazyBackgroundImage
      img={whoWeAreBgImg}
      className="text-white min-h-screen bg-no-repeat bg-cover md:bg-fixed bg-img-position pt-20 md:pt-0"
    >
      <div className="bg-cc-black bg-opacity-70 w-4/5 max-w-sm md:max-w-md md:min-h-screen md:mx-20 sm:my-20 md:my-0">
        <div className="px-4 sm:px-6 py-10 sm:py-16">
          ...
          <div className="text-sm md:text-base">
            ...
            <p>
              ...
              professionals, former varsity standouts, and everyone else in between, to shed sweat
              and stress as equals.
            </p>
          </div>
        </div>
      </div>
