    ...
    <SectionLayout>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between">
          <div className="flex flex-col md:max-w-2xl">
            ...
            <p className="mt-4 text-lg">
              You’ve probably heard that you’re a product of the people you spend the most time
              with. The ccteam knows success is a result of being challenged and encouraged by those
              on the same journey around us. Our members rediscover their connection to sport while
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col justify-center px-4 md:px-14 bg-cc-blue-900">
          ...
          <p className="text-lg">
            Connect with like-minded people who are on the same journey you are. Whether it's
            talking about the new Jordans that just dropped or having that conversation that sparks
            an idea—we cultivate the creative spirit that sport inspires.
          </p>
        </div>
      </ExpandedLayout>
      <ExpandedLayout
      ...
      >
        <div className="md:w-1/2 flex flex-col justify-center px-4 md:px-14 bg-cc-blue-900">
          ...
          <p className="text-lg">
            Our community is at the heart of everything we do and our spaces, beyond the physical,
            are built to create environments that spark connection. Crosscourt members have access
            to our Discord, a members directory, and other unique, socially designed features that
            drive relationships.
          </p>
          <Button
            className="my-4 md:mb-0 w-min"
            to={env.REACT_APP_DISCORD_LINK}
